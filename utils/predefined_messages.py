...
'''
from utils.general import DATA_DIRECTORY, get_json
import os, logging
PREDEFINED_MESSAGES_PATH = os.path.join(DATA_DIRECTORY, "predefined_messages.json")

#Logging
logger = logging.getLogger(__name__)

def get_predefined_messages():
    '''Function to get predefined message data.'''
